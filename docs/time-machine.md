...
A travelled moment is part of the address too — `?commit=<sha>` rides in
every [shareable view](shareable-views.md), so a link can hand someone the
brain as it stood at any commit.
