...
* [The hypothesis](the-hypothesis.md) - the bet: a small model with frictionless, evolving knowledge and skills beats a large model without — less VRAM, more current, more intelligence per kWh; and a knowledge graph only contributes to evolution if it is rebuilt on every commit (unlike LightRAG)
...
<!-- brainpick:begin index (hash:207bc248) -->
