...
<!-- brainpick:begin index (hash:7c9e1307) -->
...
- [Spec: T1 artifacts](reference/spec/t1-artifacts.md) — The deterministic heart — document scanning, link extraction, graph.json (nodes, edges, ghosts, islands, orphans, tags), docs.jsonl, skills.json, and the generated index and skill tree.
