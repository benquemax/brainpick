...
<!-- brainpick:begin index (hash:854b4888) -->
...
- [Reference](reference.md) — The source-derivable reference for brainpick — every CLI command, config key, spec contract, MCP tool and henxels rule, one page each, richly cross-linked.
