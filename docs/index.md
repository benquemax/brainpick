...
<!-- brainpick:begin index (hash:050ff335) -->
...
- [The brain template](brain-template.md) — The henxels starter template that scaffolds a brainpick-compatible _brain/ — the sixteen rules it enforces, how they split between henxels (structure) and brainpick (serving), what is fixed for life versus cheap to iterate, how the docs get read at all, and the migration story for later format versions.
