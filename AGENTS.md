...
<!-- brainpick:begin report (hash:b5183198) -->
...
- Counts: 149 docs · 1040 links · 20 tags · 0 orphans · 0 ghosts
- Tiers: t1 fresh · t2 fresh · t3 fresh
- Top hubs (in/out):
  - Configuration reference (reference-config.md) — 38/36
  - Architecture decision records (reference-adr.md) — 25/25
  - Henxels contract reference (reference-henxels.md) — 22/18
  - CLI reference (reference-cli.md) — 19/18
  - Compile pipeline (compile-pipeline.md) — 31/5
- Orphans:
  - (none)
- Top ghosts:
  - (none)
- Top similarity gaps:
  ...
  - agent-integrations.md ↔ reference-cli.md — 0.898
  - agent-integrations.md ↔ brain.md — 0.877
  - reference-config.md ↔ reference-spec.md — 0.877
  - federation.md ↔ reference-cli.md — 0.875
- Bundle root: docs
