...
<!-- brainpick:begin report (hash:606a112b) -->
...
- Counts: 143 docs · 944 links · 16 tags · 0 orphans · 0 ghosts
...
- Top hubs (in/out):
  ...
  - Spec reference (reference-spec.md) — 17/18
- Orphans:
  - (none)
- Top ghosts:
  - (none)
- Top similarity gaps:
  ...
  - brain-template.md ↔ reference-cli.md — 0.872
- Bundle root: docs
