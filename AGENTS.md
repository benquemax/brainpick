...
<!-- brainpick:begin report (hash:1b1cc6b1) -->
...
- Counts: 120 docs · 726 links · 14 tags · 0 orphans · 0 ghosts
- Tiers: t1 fresh · t2 stale · t3 fresh
- Top hubs (in/out):
  - Configuration reference (reference-config.md) — 28/28
  ...
  - Compile pipeline (compile-pipeline.md) — 25/5
- Orphans:
  - (none)
- Top ghosts:
  - (none)
