...
<!-- brainpick:begin report (hash:3daa8351) -->
...
- Counts: 128 docs · 793 links · 15 tags · 0 orphans · 0 ghosts
- Tiers: t1 fresh · t2 fresh · t3 fresh
- Top hubs (in/out):
  - Configuration reference (reference-config.md) — 32/31
  - Architecture decision records (reference-adr.md) — 23/23
