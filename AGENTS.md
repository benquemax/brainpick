...
<!-- brainpick:begin report (hash:1ff964e2) -->
...
- Counts: 153 docs · 1088 links · 20 tags · 0 orphans · 0 ghosts
...
- Top hubs (in/out):
  ...
  - Compile pipeline (compile-pipeline.md) — 32/5
...
- Top similarity gaps:
  ...
  - agent-integrations.md ↔ brain.md — 0.876
  - federation.md ↔ reference-cli.md — 0.875
  - reference-config.md ↔ reference-spec.md — 0.875
- Bundle root: docs
