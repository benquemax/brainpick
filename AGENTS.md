...
<!-- brainpick:begin report (hash:336da598) -->
...
- Counts: 161 docs · 1212 links · 20 tags · 0 orphans · 0 ghosts
...
- Top hubs (in/out):
  ...
  - Compile pipeline (compile-pipeline.md) — 36/7
...
- Top similarity gaps:
  ...
  - mcp-tools.md ↔ structure-agnosticism.md — 0.893
  - mcp-tools.md ↔ skills.md — 0.888
  - agent-integrations.md ↔ brain.md — 0.881
- Bundle root: docs
- Engine: brainpick 0.8.1 — 0.8.5 available: pip install -U brainpick
