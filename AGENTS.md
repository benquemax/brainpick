...
<!-- brainpick:begin report (hash:5777439b) -->
...
- Counts: 18 docs · 70 links · 0 tags · 3 orphans · 0 ghosts
- Tiers: t1 fresh · t2 fresh · t3 off
- Top hubs (in/out):
  - The tiers (the-tiers.md) — 8/6
  - Knowledge graph tier (knowledge-graph-tier.md) — 8/4
  - Compile pipeline (compile-pipeline.md) — 7/4
  - Artifact spec (artifact-spec.md) — 7/3
  - Guarded writes (guarded-writes.md) — 6/4
- Orphans:
