...
<!-- brainpick:begin report (hash:2242b05d) -->
...
- Counts: 156 docs · 1127 links · 20 tags · 0 orphans · 0 ghosts
...
- Top hubs (in/out):
  ...
  - CLI reference (reference-cli.md) — 21/20
...
- Top similarity gaps:
  ...
  - agent-integrations.md ↔ reference-cli.md — 0.902
  - brain-template.md ↔ reference-cli.md — 0.879
  - agent-integrations.md ↔ brain.md — 0.878
  - federation.md ↔ reference-cli.md — 0.877
- Bundle root: docs
