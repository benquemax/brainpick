...
<!-- brainpick:begin report (hash:ad962783) -->
...
- Counts: 122 docs · 743 links · 15 tags · 0 orphans · 0 ghosts
- Tiers: t1 fresh · t2 fresh · t3 fresh
- Top hubs (in/out):
  - Configuration reference (reference-config.md) — 29/28
  - Architecture decision records (reference-adr.md) — 22/22
  - Henxels contract reference (reference-henxels.md) — 20/18
  - CLI reference (reference-cli.md) — 17/16
  - Compile pipeline (compile-pipeline.md) — 26/5
- Orphans:
  - (none)
- Top ghosts:
  - (none)
- Top similarity gaps:
  - agent-integrations.md ↔ reference-cli.md — 0.892
  - reference-config.md ↔ reference-spec.md — 0.868
  - agent-integrations.md ↔ daemon.md — 0.867
  - reference/cli/show.md ↔ reference/spec/presentations.md — 0.861
  - agent-integrations.md ↔ reference/cli/search.md — 0.859
- Bundle root: docs
