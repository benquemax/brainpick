...
<!-- brainpick:begin report (hash:4e7946ca) -->
...
- Counts: 117 docs · 697 links · 0 tags · 0 orphans · 0 ghosts
- Tiers: t1 fresh · t2 stale · t3 stale
- Top hubs (in/out):
  - Configuration reference (reference-config.md) — 28/28
  - Architecture decision records (reference-adr.md) — 21/21
  - Henxels contract reference (reference-henxels.md) — 19/17
