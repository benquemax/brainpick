...
| `105-contribute.md` | read-only implants, `brain_contribute` / `brain_submit` — proposing changes upstream as pull requests from a worktree · **PROPOSED, partially implemented** |
